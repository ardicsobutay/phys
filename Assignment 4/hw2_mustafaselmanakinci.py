from hw1_mustafaselmanakinci import *
import time
...
#
    ...
    wordList: list (string)
    """
def uComp(hand, wordList):
    inpt = None
    while inpt != "u" and inpt != "c":
...
def playGame(wordList):
    ...
    flg = 0
    while inpt != "e":
        inpt = raw_input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
        if inpt == "n":
            flg = 1

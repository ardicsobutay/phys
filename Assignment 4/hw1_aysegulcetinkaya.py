    ...
    while calculateHandlen(hand) > 0:
        ...
        if userInput == ".":
            ...
            if not isValidWord(userInput,hand,wordList):
                print "Invalid word, you moron!"
                print
            else :
                score = getWordScore(userInput,n)
                totalScore+=score
                print "Your word earned " + str(score) + " points, and yout total score is " +str(totalScore)
                hand = updateHand(hand,userInput)
                
    if calculateHandlen(hand) > 0 :     
        print "Goodbye! Total score is " + str(totalScore)
    else :
        print "Ran out of letters! Total Score is "  + str(totalScore)

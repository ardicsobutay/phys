...
def getWordScore(word, n):
    ...
    point = 0;
    for x in list(word):
        point += SCRABBLE_LETTER_VALUES[x];
        pass
...
def playGame(wordList):
    ...
    while 1:
        ...
        userInput = raw_input('n for new, r for repeat, e to exit: ')
        ...
        if userInput == 'n':
            ...
            print "Yanlis bir numara tusladiniz. Operatore baglanmak icin lutfen bekleyiniz..."
